...
export function DeleteTenantButton({ tenantId, tenantName, returnTo }: DeleteTenantButtonProps) {
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 p-4" onClick={() => setIsOpen(false)}>
          ...
          >
            ...
            <p id={descriptionId} className="mt-2 text-sm text-muted">
              O tenant {tenantName} sera removido permanentemente. Deseja continuar?
            </p>
