...
export function DeleteUserButton({ userId, userLabel, returnTo }: DeleteUserButtonProps) {
    ...
    <>
      ...
      {isOpen ? (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 p-4" onClick={() => setIsOpen(false)}>
          ...
          >
            <h3 id={titleId} className="text-base font-semibold text-foreground">Confirmar remocao de usuario</h3>
            <p id={descriptionId} className="mt-2 text-sm text-muted">
              O usuario {userLabel} sera removido do tenant atual. Deseja continuar?
            </p>
