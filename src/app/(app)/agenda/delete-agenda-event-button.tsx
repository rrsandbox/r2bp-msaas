...
type DeleteAgendaEventButtonProps = {
  eventId: string;
  returnTo: string;
};

export function DeleteAgendaEventButton({ eventId, returnTo }: DeleteAgendaEventButtonProps) {
    ...
    <>
      ...
      {isOpen ? (
        ...
        >
          ...
          >
            <h3 id={titleId} className="text-base font-semibold text-foreground">Confirmar exclusao</h3>
            <p id={descriptionId} className="mt-2 text-sm text-muted">
              Esta acao remove o evento permanentemente. Deseja continuar?
            </p>
