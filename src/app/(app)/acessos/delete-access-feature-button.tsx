...
import { deleteAccessFeatureAction } from "@/app/(app)/acessos/actions";

type DeleteAccessFeatureButtonProps = {
  featureId: string;
  featureName: string;
  returnTo: string;
};

export function DeleteAccessFeatureButton({ featureId, featureName, returnTo }: DeleteAccessFeatureButtonProps) {
    ...
    <>
      ...
      {isOpen ? (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 p-4" onClick={() => setIsOpen(false)}>
          ...
          >
            <h3 id={titleId} className="text-base font-semibold text-foreground">Confirmar remocao</h3>
            <p id={descriptionId} className="mt-2 text-sm text-muted">
              A feature {featureName} sera removida permanentemente junto com as permissoes vinculadas. Deseja continuar?
            </p>
            ...
            <div className="mt-4 flex items-center justify-end gap-2">
              ...
              <form action={deleteAccessFeatureAction}>
